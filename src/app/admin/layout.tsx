...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-neutral-950 text-neutral-100">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-neutral-900 border-r border-neutral-800 transform transition-transform duration-200 lg:translate-x-0 lg:static lg:z-auto ${
      ...
      >
        <div className="flex items-center gap-2 px-6 py-5 border-b border-neutral-800">
          ...
          <div>
            <p className="text-sm font-semibold text-white">Green Studio</p>
        ...
        <header className="flex items-center justify-between h-16 px-6 bg-neutral-900 border-b border-neutral-800">
          ...
          <div className="flex items-center gap-4 ml-auto">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-neutral-300 hidden sm:inline">Admin</span>
            </div>
            <button
              onClick={() => {
